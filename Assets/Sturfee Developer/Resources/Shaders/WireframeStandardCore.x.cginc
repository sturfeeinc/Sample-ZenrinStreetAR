...
#include "Assets/Digicrafts/WireframeGrid/Shaders/Core/WireframeStandardInput.cginc"
...
struct VertexOutputForwardBase
{
	...
	// next ones would not fit into SM2.0 limits, but they are always for SM3.0+
		...
		DC_WIREFRAME_COORDS_STANDARD(10,11)
	#else
		DC_WIREFRAME_COORDS(10,11)
	#endif
...
VertexOutputForwardBase vertForwardBase (VertexInput v)
{
	...
	#if UNITY_SPECCUBE_BOX_PROJECTION
		DC_WIREFRAME_TRANSFER_COORDS_STANDARD(o);
	#else
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
	...
	DC_APPLY_WIREFRAME_STANDARD(s.diffColor,s.alpha,i)
	#endif
	...
	c.rgb += Emission(i.tex.xy);
		...
		#if UNITY_SPECCUBE_BOX_PROJECTION
			DC_APPLY_WIREFRAME_STANDARD(c.rgb,s.alpha,i)
		#else
			DC_APPLY_WIREFRAME(c.rgb,s.alpha,i)
		#endif
	#endif
...
half4 fragForwardAddInternal (VertexOutputForwardAdd i)
{
	...
	#if _WIREFRAME_LIGHTING
		DC_APPLY_WIREFRAME(s.diffColor,s.alpha,i)
	#endif
...
struct VertexOutputDeferred
{
	...
	half4 ambientOrLightmapUV			: TEXCOORD5;	// SH or Lightmap UVs			
		...
		DC_WIREFRAME_COORDS_STANDARD(8,9)
	#else
		DC_WIREFRAME_COORDS(8,9)
	#endif
	#if UNITY_OPTIMIZE_TEXCUBELOD
		#if UNITY_SPECCUBE_BOX_PROJECTION
...
)
{
	...
	#if UNITY_SPECCUBE_BOX_PROJECTION
		DC_APPLY_WIREFRAME_STANDARD(color.rgb,occlusion,i);
	#else
		DC_APPLY_WIREFRAME(color.rgb,occlusion,i);
	#endif
